			...
			<div class="db-cent">
				...
				<div class="db-cent-2">
					<div class="db-2-main-1">
						<div class="db-2-main-2"> <img src="{{asset('frontend/images/icon/dbc5.png')}}" alt=""> <span>My Bookings</span>
							<p>All the Lorem Ipsum generators on the</p>
							<h2>{{$bookings}}</h2> </div>
					</div>
					<div class="db-2-main-1">
						<div class="db-2-main-2"> <img src="{{asset('frontend/images/icon/dbc6.png')}}" alt=""> <span>Events</span>
							<p>All the Lorem Ipsum generators on the</p>
							<h2>04</h2> </div>
					</div>
					<div class="db-2-main-1">
						<div class="db-2-main-2"> <img src="{{asset('frontend/images/icon/dbc3.png')}}" alt=""> <span>Payment</span>
							<p>All the Lorem Ipsum generators on the</p>
							<h2>{{$status}}</h2></div>
					</div>
				</div>
				...
				<div class="db-cent-3">
					<div class="db-cent-table db-com-table">
						<div class="db-title">
							<h3><img src="{{asset('frontend/images/icon/dbc6.png')}}" alt=""/> My Events</h3>
							<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
						</div>
						<table class="bordered responsive-table">
							<thead>
				...
				<div class="db-cent-3">
					<div class="db-cent-acti">
						<div class="db-title">
							<h3><img src="{{asset('frontend/images/icon/dbc1.png')}}" alt=""/> My Activity</h3>
							<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
						</div>
						<ul>
							<li>
								<div class="db-cent-wr-img"> <img src="{{asset('frontend/images/users/3.png')}}" alt=""> </div>
