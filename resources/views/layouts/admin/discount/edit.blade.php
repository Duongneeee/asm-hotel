    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="mb-3 ">
                ...
                <input type="number" name="price" class="form-control {{$errors->has('price')?'is-invalid':''}}" placeholder="Giá giảm..." value="{{old('price') ?? $discount->price}}">
                @error('price')
                <div  class="invalid-feedback">
                    {{$message}}
                  </div>
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <select name="value" id="" class="form-control {{$errors->has('value')?'is-invalid':''}}">
                    ...
                    <option value="1" {{old('value') == 1 ||  $discount->value == 0 ? 'selected':false}}>Phần trăm</option>
                </select>
                @error('value')
                <div  class="invalid-feedback">
                    {{$message}}
