    ...
    <div class="row">
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="text" name="code" class="form-control {{$errors->has('code')?'is-invalid':''}}" placeholder="Mã giảm giá..." value="{{old('code')}}">
                @error('code')
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="date" name="start" class="form-control {{$errors->has('start')?'is-invalid':''}}"  value="{{old('start')}}">
                @error('start')
                <div  class="invalid-feedback">
                    {{$message}}
                  </div>
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <select name="value" id="" class="form-control {{$errors->has('value')?'is-invalid':''}}">
                    <option value="0" {{old('value') == 0  ? 'selected':false}}>Tiền</option>
                    <option value="1" {{old('value') == 1  ? 'selected':false}}>Phần trăm</option>
                </select>
                @error('value')
                <div  class="invalid-feedback">
                    {{$message}}
